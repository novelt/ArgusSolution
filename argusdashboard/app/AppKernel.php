...
class AppKernel extends Kernel
{
    ...
    {
        // Load rootConfig file to know which instance of App use
        $array = Yaml::parse(file_get_contents($this->getRootDir().'/config/configRoot.yml'));
        $instance = $array['parameters']['instance'];

        $loader->load(__DIR__.'/config/'.$instance.'/config_'.$this->getEnvironment().'.yml');
    }
}
