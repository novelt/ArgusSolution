    ...
    public void initListAdapter() {
        ...
        CursorAdapter adapter = new CursorAdapter(this, cur) {                    
             public View newView(Context context, Cursor cursor, ViewGroup parent) {
                return inflater.inflate(org.argus.gateway.R.layout.inbox_item, null);
             }
             
             public void bindView(View view, Context context, Cursor cursor)
             {
                TextView addrText = (TextView) view.findViewById(org.argus.gateway.R.id.inbox_address);
                TextView bodyText = (TextView) view.findViewById(org.argus.gateway.R.id.inbox_body);
