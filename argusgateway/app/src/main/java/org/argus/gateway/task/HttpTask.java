...
import org.argus.gateway.Base64Coder;
...
public class HttpTask extends BaseHttpTask {
    ...
    protected Boolean doInBackground(String... ignored) {
        ...
        params.add(new BasicNameValuePair("phone_operator", app.getNetworkOperator()));
        ...
        params.add(new BasicNameValuePair("poll_interval", "" + app.getOutgoingPollSeconds()));
        params.add(new BasicNameValuePair("number_of_retry", "" + app.getNumberOfRetries()));
    ...
    {
        app.log(this.getClass().toString());
