...
import org.argus.gateway.receiver.IncomingMessageRetry;
import org.argus.gateway.task.ForwarderTask;
...
public abstract class IncomingMessage extends QueuedMessage {
    ...
    public String getDescription()
    {
        if (direction == Direction.Sent)
        {
            return "Sent " + getDisplayType() + " to " + getTo() + " (" + getMessageId() + ")";
        }
        else
        {
            return getDisplayType() + " from " + getFrom() + " (" + getMessageId() + ")";
        }
    }
