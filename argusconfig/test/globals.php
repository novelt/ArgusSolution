<?php
    ...
    $config["application_name"]    = "AVADAR";

	// Application version
	$config["ses_version"]         = "ARGUS v6.0.3 - 22/02/2017";
	$config["schema_version"]      = "6.0.3";
	...
	$config["mysql_db"]            = "gateway_test"; 		// frontlinesms_togo_20160726
	...
	$config["xampp_path"]           	= "D:\\ProgramFiles\\xampp" . DIRECTORY_SEPARATOR;
	// Php ini
	...
	// ArgusSMS settings
	$config["ArgusSMS_secret"]				= "0011" ;
	$config["ArgusSMS_pendingSms"]			= "10" ;
	$config["ArgusSMS_errorLimit"]			= "30" ;

	// Gateway diagnosis
	$config["Gateway_alive_minutes"]		= "10" ; // Minutes before considering a gateway is off
